            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 2.h),
                  Text(
                    'To-Do tasks are occasional tasks with brief description, like completing assignments or a shopping list. These tasks aren’t tracked for growth but need to be completed.',
                    textAlign: TextAlign.center,
                    style: GoogleFonts.plusJakartaSans(
                        fontSize: 14.sp, color: Colors.grey),
                  ),

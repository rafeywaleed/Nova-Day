  ...
  class _NotificationSettingsPageState extends State<NotificationSettingsPage> {
    ...
    Future<void> selectTime(BuildContext context, bool isFirstTime) async {
      ...
      if (picked != null && picked != selectedTime) {
        ...
        final prefs = await SharedPreferences.getInstance();
        if (isFirstTime) {
          await prefs.setString('firstNotificationTime', DateTime(0, 0, 0, picked.hour, picked.minute).toIso8601String());
        } else {
          await prefs.setString('secondNotificationTime', DateTime(0, 0, 0, picked.hour, picked.minute).toIso8601String());
        }
      }
    }
              ...
              Row(
                ...
                children: [
                  ...
                  TextButton(
                    ...
                    child: Text(
                      '${firstNotificationTime.format(context)}',
                      style: GoogleFonts.plusJakartaSans(
              ...
              Row(
                ...
                children: [
                  ...
                  TextButton(
                    ...
                    child: Text(
                      '${secondNotificationTime.format(context)}',
                      style: GoogleFonts.plusJakartaSans(
                          fontSize: 16, color: Colors.blue),
                    ),
                  ),
